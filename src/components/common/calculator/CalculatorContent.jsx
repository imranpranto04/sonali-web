...
const CalculatorContent = ({ onStart }) => {
  return (
    <>
      <div className="bg-white text-slate-900 rounded-3xl shadow-2xl p-8 md:p-12 min-h-[500px] flex flex-col justify-center items-center text-center animate-in fade-in zoom-in-95 duration-500">
        ...
        <button
          onClick={onStart}
          className="w-full max-w-xs bg-orange-500 text-white py-4 rounded-xl font-bold text-lg shadow-xl shadow-orange-500/20 hover:scale-105 hover:bg-orange-600 transition-all flex items-center justify-center gap-2"
        >
