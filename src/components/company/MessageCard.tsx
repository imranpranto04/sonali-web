...
export function MessageCard({
  ...
  return (
    ...
    //   <div className="w-full lg:w-[400px] shrink-0 relative group cursor-pointer mx-auto lg:mx-0">
    ...
    //       <div className="absolute bottom-0 left-0 right-0 p-6 bg-linear-to-t from-black/80 via-black/40 to-transparent text-white lg:hidden">
